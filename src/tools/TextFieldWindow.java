...
/**
 * A Window-PopUp, containing a TextField with a Label in front of it, as well as a Confirm and a Cancel Button.
 * Confirm will send the String inside the TextField  to the readTextFieldString-Method of the Object that opened the Window.
 * 
 ...
 * @param refID An Integer in order to call different Methods with readTextFieldString. (use switch)
