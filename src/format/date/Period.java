...
public class Period implements Comparable<Period> {
	...
	/**
	 * Constructs a period from the given dates. Unknown dates are allowed. null is
	 * allowed for the date 'to'
	 * 
	 * @param from
	 * @param to
	 ...
	 * 
	 * @param stDate
	 * @throws IllegalArgumentException if the given start date is later than the
	 *                                  existing end date.
	 */
	 ...
	 * 
	 * @param endDate
	 * @throws IllegalArgumentException if the given end date is earlier than the
	 *                                  existing start date.
	 */
	...
	/**
	 * Compares the start dates of the periods, if they are not equal. If the start
	 * dates are equal, compares the end dates of the periods.
	 */
